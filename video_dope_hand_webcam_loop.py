...
test_resize_width = 1280
test_resize_height = 720

txt_size = 1
txt_line_width = 1


out_vid_names = ["outputAutoExposure_" + str(test_resize_height) + ".avi",
                 "E8_" + str(test_resize_height) + ".avi",
                 "E9_" + str(test_resize_height) + ".avi",
                 "E9a_" + str(test_resize_height) + ".avi",
                 "E9b_" + str(test_resize_height) + ".avi",
                 "E10_" + str(test_resize_height) + ".avi"
                 ]
...
for vid_path, out_vid_name in zip(vid_paths, out_vid_names):
    ...
    while cap.isOpened():
        ...
        if print_detections:
            txt_y_offset = 100
            cv2.putText(img_draw, 'Input size: ' + str(test_resize_height) + 'p', (10, txt_y_offset - 75), font, txt_size,
